from app import db, app  # ✅ Importar la base de datos y la aplicación
...
def test_login(client):
    ...
    with client.application.app_context():  # Asegurar que estamos en contexto de Flask
...
def test_dashboard_requires_login(client):
    ...
    assert response.status_code == 200
    assert "Ingresar" in response.data.decode("utf-8")  # ✅ Ajuste según el HTML devuelto
